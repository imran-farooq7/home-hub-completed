...
const AboutPage = () => {
	...
	return (
		<div className="mt-8">
			<div className="grid grid-cols-1 lg:grid-cols-2 lg:grid-rows-[auto_1fr] gap-y-16 sm:gap-y-12">
					...
					<ul className="space-y-4">
						{socialLinks.map((link) => (
							<li className="flex" key={link.text}>
								<a
									href="#"
									className="flex group text-base font-medium text-zinc-800 transition hover:text-purple-500 dark:text-zinc-200 dark:hover:text-purple-500"
								>
